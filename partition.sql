...
select * from orders_range
where order_date  between '2024-04-08'and '2024-04-10';

select * from orders_range
where order_date in ('2024-04-08','2024-04-10','2024-05-09');

select * from orders_range
where (order_date between '2024-03-01'  and '2024-05-09')
or order_date in ('2024-04-07','2024-04-02','2024-04-08');
...
select * from orders_list
where region in ('india','UK');

# partition hash and key
